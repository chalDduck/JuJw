...
export const metadata: Metadata = buildPageMetadata({
  ...
  path: '/diamond-wholesale',
  image: '/img/products-generated/products-card-ring.png',
  imageAlt: 'JU JEWELRY 다이아몬드 도매',
})
...
export default function DiamondWholesalePage() {
  return (
    <>
      <BreadcrumbJsonLd
        items={[{ name: '홈', path: '/' }, { name: '다이아몬드 도매', path: '/diamond-wholesale' }]}
      />
