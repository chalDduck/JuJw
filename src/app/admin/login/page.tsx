    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#f7f4ef_0%,#f3ece3_100%)] px-4 py-8 text-stone-900 sm:px-6">
      <div className="mx-auto flex min-h-[calc(100dvh-4rem)] w-full max-w-5xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-[32px] border border-stone-200 bg-white shadow-[0_30px_90px_-46px_rgba(28,25,23,0.45)] lg:grid-cols-[0.9fr_1.1fr]">
          <section className="hidden bg-stone-900 px-6 py-8 text-white sm:px-8 lg:flex lg:flex-col lg:justify-between lg:p-10">
            <div>
          ...
          <section className="px-5 py-7 sm:px-8 sm:py-9 lg:p-10">
            <h1 className="text-[28px] font-bold tracking-tight text-stone-950">관리자 로그인</h1>
            ...
            <form className="mt-7 space-y-5" onSubmit={onSubmit}>
              <div>
                <label htmlFor="admin-email" className="mb-2 block text-[17px] font-semibold text-stone-800">아이디</label>
                <input
                  id="admin-email"
                  type="text"
                  value={email}
              ...
              <div>
                <label htmlFor="admin-password" className="mb-2 block text-[17px] font-semibold text-stone-800">비밀번호</label>
                <div className="relative">
                  <input
                    ...
                    className="min-h-[60px] w-full rounded-2xl border border-stone-300 px-4 pr-14 text-[18px] text-stone-900 outline-none transition focus:border-stone-900 focus:ring-4 focus:ring-stone-200/70"
                    required
                  />
                  <button
                    type="button"
                    ...
                    className="absolute inset-y-0 right-0 inline-flex w-14 items-center justify-center text-stone-600"
                  >
