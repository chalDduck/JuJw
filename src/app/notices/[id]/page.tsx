    ...
    <div className="min-h-screen bg-[#f7f2eb] text-[#33261f]">
      <article className="public-hero px-4 pb-20 sm:px-6 md:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="mt-4 text-[1.9rem] font-semibold leading-[1.3] tracking-[-0.02em] text-[#2f241d] sm:text-[2.6rem]">
            {notice.title}
          </h1>

          <div className="mt-8 h-px w-full bg-[#dfd0bf]" />

          <div className="mt-8 whitespace-pre-wrap text-[16px] leading-9 text-[#42342b]">
            {notice.content}
          </div>
