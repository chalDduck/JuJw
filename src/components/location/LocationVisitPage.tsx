...
const directions = [
  {
    title: '지하철',
    body: '1호선 종로5가역 1번 출구 또는 1·3·5호선 종로3가역 11번 출구에서 도보 이동 가능합니다. 종로5가역 1번 출구 이용 시 가장 단순한 동선으로 오실 수 있으며, 예약 확정 후 이용 노선에 맞춰 자세한 길 안내를 도와드립니다.',
    Icon: TrainFront,
  },
  {
    title: '버스',
    body: '종로4가, 종로4가·종묘, 종묘공원, 종로5가입구 정류장에서 하차 후 종묘귀금속백화점 방향으로 이동하시면 됩니다. 도착 정류장에 따라 가장 가까운 하차 위치와 도보 동선을 함께 안내해 드립니다.',
    Icon: MapPinned,
  },
  {
    title: '자가용',
    body: '주소는 서울 종로구 종로 173, 종묘귀금속백화점입니다. 차량 방문 시 인근 종묘 공영주차장 이용을 권장드리며, 종로 일대는 교통 및 주차 혼잡이 있을 수 있어 방문 전 미리 말씀해 주시면 더 빠르게 안내해 드립니다.',
    Icon: CarFront,
  },
] as const
